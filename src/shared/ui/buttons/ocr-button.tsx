...
export const OcrButton = ({ className, ...props }: OcrButtonProps) => {
	return (
		<button
			...
			{...props}
			className={cn(
				"mx-auto flex w-[23.6rem] items-center justify-center gap-[1.2rem] whitespace-nowrap rounded-[12px] border border-primary-600 bg-primary-50 px-[1.6rem] py-[1.2rem] transition-default active:bg-primary-100",
				className,
			)}
		>
