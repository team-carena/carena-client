		...
		<PopoverPrimitive.Portal>
			<PopoverPrimitive.Content
				...
				className={cn(
					...
					"group body05-r-12 z-5 w-[25.6rem] whitespace-pre-wrap rounded-[12px] border border-gray-300 bg-white p-[2.4rem] text-gray-900 outline-none [-webkit-tap-highlight-color:transparent]",
