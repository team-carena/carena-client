...
const PRIVACY_CONSENT_TEXT = `CareNA는 「개인정보보호법」 제23조에 따라 건강정보에 해당하는 민감정보를 아래와 같이 수집·이용합니다.

1. 수집·이용 목적
건강검진 결과의 분석 및 건강점수 산출(동일 검진일자 결과 수정 포함)
AI 기술을 활용한 맞춤형 식단 추천 제공
      ※ AI 활용 과정에서는 이름·생년월일 등 개인을 식별할 수
         있는 정보가 제공되지 않습니다.

2. 수집 항목
건강검진 결과에 포함된 건강정보(사용자가 입력하거나 OCR로 추출 후 저장한 정보)
...
4. 동의 거부 권리 및 불이익 안내
귀하는 민감정보 수집·이용에 대한 동의를 거부할 권리가 있습니다.
단, 동의하지 않을 경우 검진 결과 저장 및 결과 분석 서비스, AI 맞춤 식단 추천 이용이 불가합니다.`;
